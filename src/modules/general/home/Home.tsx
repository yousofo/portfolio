"use client";
import SpinningBullet from "@/modules/general/shared/SpinningBullet";
import WavyText from "../shared/WavyText";
import * as motion from "motion/react-client";
import Image from "next/image";
import Skill from "@/modules/general/shared/Skill";
function Home() {
  const colors = [
    "bg-amber-300",
    "bg-blue-300",
      ...
      >
        <div className="name overflow-hidden sm:me-2 text-foreground transition-colors tracking-wide text-center">
          <h2 className="font-bold text-4xl lg:text-5xl  ">
            Hello! <span className="text-3xl lg:text-4xl">I&apos;m Youssef</span>
          </h2>
